...
export function LargeText({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('text-lg font-semibold', className)} {...props} />;
}

export function SmallText({ className, ...props }: React.HTMLAttributes<HTMLElement>) {
